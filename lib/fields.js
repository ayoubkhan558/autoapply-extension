...
var AA_FIELD_DEFS = [
  ...
  { group: "personal", name: "address1", label: "Address line 1", words: ["address line 1", "street address", "address", "street"], attrs: ["address1", "addressline1", "street-address", "street", "address"] },
  { group: "personal", name: "address2", label: "Address line 2", words: ["address line 2", "apartment", "suite", "unit"], attrs: ["address2", "addressline2", "apt", "suite"] },
  { group: "personal", name: "currentAddress", label: "Current address", words: ["current address", "present address", "residential address"], attrs: ["currentaddress", "presentaddress", "residentialaddress"] },
  { group: "personal", name: "permanentAddress", label: "Permanent address", words: ["permanent address", "home address"], attrs: ["permanentaddress", "homeaddress"] },
  { group: "personal", name: "city", label: "City", words: ["city", "town"], attrs: ["city", "town", "locality"] },
  { group: "personal", name: "state", label: "State / Province", words: ["state", "province", "region", "state / province", "state province", "county"], attrs: ["state", "province", "region", "administrativearea", "stateprovince", "addresslevel1"] },
  { group: "personal", name: "zip", label: "ZIP / Postal code", words: ["zip code", "postal code", "postcode", "zip"], attrs: ["zip", "zipcode", "postalcode", "postcode", "postal_code", "postal"] },
  { group: "personal", name: "country", label: "Country", words: ["country", "country of residence", "country region"], attrs: ["country", "countryname", "countryregion"] },
  ...
  { group: "links", name: "portfolio", label: "Portfolio", words: ["portfolio"], attrs: ["portfolio"] },
  { group: "links", name: "website", label: "Personal website", words: ["personal website", "website", "url"], attrs: ["website", "url", "homepage"] },
  ...
  { group: "professional", name: "skills", label: "Skills", long: true, words: ["key skills", "technical skills", "skills", "areas of expertise", "core competencies", "tech stack", "technologies", "skill set"], attrs: ["skills", "keyskills", "techskills", "expertise", "competencies", "techstack"] },
  ...
  { group: "professional", name: "employmentStatus", label: "Employment status", words: ["employment status", "current employment status"], attrs: ["employmentstatus"] },
  ...
  { group: "professional", name: "preferredLocations", label: "Preferred locations", words: ["preferred locations", "preferred location", "desired location", "location preference"], attrs: ["preferredlocation", "preferredlocations", "desiredlocation"] },
  ...
  { group: "professional", name: "availableStartDate", label: "Available start date", words: ["available start date", "earliest start date", "available from", "date available", "available date", "availability date", "when can you start", "earliest availability", "available to start"], attrs: ["availablestartdate", "earlieststartdate", "availablefrom", "dateavailable", "availabledate", "whencanyoustart", "availabilitydate"] },
  ...
  { group: "professional", name: "noticePeriod", label: "Notice period", words: ["notice period", "notice", "how much notice", "current notice period"], attrs: ["notice", "noticeperiod"] },
